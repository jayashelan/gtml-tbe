...
public class KafkaConfigBuilder {
    ...
    public Map<String, String> convert() {
        ...
        return objectMapper.convertValue(configs.kafka.option, new TypeReference<Map<String, String>>() {
        });
    ...
    public void constructKafkaURL() {
        ...
        setKafkaURL(getKafkaTopicURL(configs.kafka.topic));
    ...
    public GtmlConfiguration getConfigs() {
        return configs;
    }

    public void setConfigs(GtmlConfiguration configs) {
